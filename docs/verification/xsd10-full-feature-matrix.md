...
| `xs:any` | partially supported | `TASK-0052`, `TASK-0059`, `TASK-0062`, `TASK-0070` | Retained element fragments support accepted locations, namespace-token handling, process metadata, wildcard choice branch binding, strict/lax schema-known validation for accepted retained declarations, and one mapped W3C wildcard row set; remaining derivation interactions and broader W3C row mapping stay future. |
