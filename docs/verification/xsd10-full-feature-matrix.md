...
| `xs:any` / `xs:anyAttribute` | partially supported | `TASK-0052`, `TASK-0059`, `TASK-0062`, `TASK-0070`, `TASK-0080` | Retained element and attribute fragments support accepted locations, namespace-token handling, process metadata, wildcard choice branch binding, strict/lax schema-known validation for accepted retained declarations, one mapped W3C element-wildcard row set, and one mapped W3C strict `anyAttribute` row set; remaining derivation interactions and broader W3C row mapping stay future. |
...
| Identity constraints | partially supported | `TASK-0054`, `TASK-0063` | Generated validators build private document-scope identity tables for accepted model shapes, enforcing `unique`, `key`, and `keyref`; `TASK-0063` adds nilled-field handling. Broad W3C generated-binding mapping remains incomplete after `TASK-0070`. |
| W3C XML Schema 1.0 suite intake | supported as classification and mapped-row evidence | `TASK-0055`, `TASK-0064`, `TASK-0070`, `TASK-0080` | The pinned W3C 2007-06-20 suite archive is classified by the opt-in `w3cXsd10Conformance` lane. `TASK-0064` maps three `AttrDecl` rows to generated-binding support, `TASK-0070` adds three wildcard rows, and `TASK-0080` adds three strict `anyAttribute` wildcard rows. Three mapped generated-binding executions pass; the remaining rows are still classification evidence until explicitly mapped or scoped out. |
| Full XSD 1.0 readiness claim | supported for generated-binding scope | `TASK-0056`, `TASK-0058`, `TASK-0064`, `TASK-0065`, `TASK-0066` | `TASK-0056` reconciled the earlier evidence and kept `XP-XSD10-FULL` non-executable at that time. `TASK-0058` defines the 1.0.0 blocker sequence. `TASK-0059` through `TASK-0066` have accepted grouped content-list, automata/UPA, dynamic typing, wildcard deep-validation, datatype/nil/identity-edge, W3C generated-binding mapping, full-profile enablement, and final release-readiness gates. |
