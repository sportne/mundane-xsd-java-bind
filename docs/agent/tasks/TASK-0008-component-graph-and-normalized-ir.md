...
Task ID: `TASK-0008`
Gate: Phase 2 schema compiler vertical slice; starts only after `TASK-0007` is accepted.
...
Tests to add/update: golden IR tests for simple elements, complex types, nested elements, attributes, sequence ordering, cardinality, namespaces, imports/includes, duplicate names, unresolved references, and deterministic diagnostic ordering
...
- Coverage: graph and IR behavior must be tested through public module-level seams inside generator-core.
