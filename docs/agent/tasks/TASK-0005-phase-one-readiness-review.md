...
Commands to run: `./gradlew designControlStatus`
Acceptance criteria: first implementation task has requirements, allowed files, test plan, and acceptance criteria.
