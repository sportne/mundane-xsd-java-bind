...
Allowed files: `modules/generator-core/src/main/java/io/github/mundanej/mxjb/generator/core/bind/**`, `modules/generator-core/src/main/java/io/github/mundanej/mxjb/generator/core/diagnostics/**`, `modules/generator-core/src/test/java/io/github/mundanej/mxjb/generator/core/**`, `modules/generator-core/src/test/resources/**`, and directly related traceability/conformance docs
...
Expected behavior: transform normalized schema IR into an internal binding model containing deterministic Java package names, type names, field names, collection shapes, writer/reader planning metadata, and basic validation-plan metadata for supported `XP-DATA-10` constructs. Supported phase-one complex types are record candidates; final classes/builders remain reserved future shapes.
Tests to add/update: golden binding-model tests for namespace-to-package mapping, name collision handling, record-candidate model shape, repeated/optional field shapes, attribute and element fields, validation-plan metadata, unsupported scalar diagnostics, IR diagnostic propagation, and deterministic diagnostics
...
Acceptance criteria: binding model is deterministic; generated-code style decisions are represented but no Java source is emitted; default generated package is `io.github.mundanej.mxjb.generated` unless overridden by binding configuration; `xs:choice` remains profile-gated unless a later task approves it; no public generator API is added
