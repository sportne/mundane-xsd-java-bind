...
Status: completed for the current scaffold; repeat after design-control file moves or governance changes.
...
Commands to run: `./gradlew validateDesignControlPack`, `./gradlew projects`
