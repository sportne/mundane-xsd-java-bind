...
- `TASK-0061` declared complex-base element fields with known concrete derived types emit generated
  sealed `xsiType` interfaces plus branch records. The default branch represents the declared base
