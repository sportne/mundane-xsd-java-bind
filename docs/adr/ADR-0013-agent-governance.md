...
Coding-agent rules, task-card scoping, and PR checklists are part of the engineering system.

## Consequences

Prevents uncontrolled implementation and scope creep.
