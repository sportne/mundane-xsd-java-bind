...
| Namespaces | Namespaces in XML | `XP-DATA-10` | designed | `T-NS-FRONTEND-*`, `T-NS-IR-*`, `T-NS-BIND-*`, `T-NS-WRITER-*` | raw syntax capture in `TASK-0007`; QName resolution in `TASK-0008`; package mapping in `TASK-0009`; writer `XmlName` constants in `TASK-0012` |
| `xs:element` simple | XSD 1.0 | `XP-DATA-10` | designed | `T-ELEMENT-FRONTEND-*`, `T-ELEMENT-IR-*`, `T-ELEMENT-BIND-*`, `T-ELEMENT-WRITER-*` | raw syntax capture in `TASK-0007`; normalized IR in `TASK-0008`; root/field binding in `TASK-0009`; generated writer output in `TASK-0012` |
| `xs:complexType` | XSD 1.0 | `XP-DATA-10` | designed | `T-COMPLEX-FRONTEND-*`, `T-COMPLEX-IR-*`, `T-COMPLEX-BIND-*`, `T-COMPLEX-WRITER-*` | raw syntax capture in `TASK-0007`; normalized IR in `TASK-0008`; record-candidate binding in `TASK-0009`; nested writer helpers in `TASK-0012` |
| `xs:sequence` | XSD 1.0 | `XP-DATA-10` | designed | `T-SEQUENCE-FRONTEND-*`, `T-SEQUENCE-IR-*`, `T-SEQUENCE-BIND-*`, `T-SEQUENCE-WRITER-*` | raw syntax capture in `TASK-0007`; normalized IR in `TASK-0008`; sequence metadata in `TASK-0009`; writer element order in `TASK-0012` |
