...
| `xs:sequence` | XSD 1.0 | `XP-DATA-10` | designed | `T-SEQUENCE-FRONTEND-*`, `T-SEQUENCE-IR-*`, `T-SEQUENCE-BIND-*`, `T-SEQUENCE-WRITER-*`, `T-SEQUENCE-READER-*` | raw syntax capture in `TASK-0007`; normalized IR in `TASK-0008`; sequence metadata in `TASK-0009`; writer element order in `TASK-0012`; reader order/cardinality diagnostics in `TASK-0015` |
