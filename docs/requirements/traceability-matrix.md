...
| `REQ-SCHEMA-001` | `ADR-0006` | `compiler-pipeline.md` | `TASK-0007` frontend syntax tests; `TASK-0008` normalized IR tests; later round-trip tests | accepted |
| `REQ-SCHEMA-002` | `ADR-0006` | `compiler-pipeline.md`, `generated-code-contract.md` | `TASK-0007` frontend syntax tests; `TASK-0008` normalized IR tests; later generated compile tests | accepted |
| `REQ-SCHEMA-003` | `ADR-0006` | `compiler-pipeline.md`, `validation-architecture.md` | `TASK-0007` sequence syntax tests; `TASK-0008` sequence IR tests; later valid/invalid sequence tests | accepted |
| `REQ-SCHEMA-004` | `ADR-0006`, `ADR-0007` | `compiler-pipeline.md`, `validation-architecture.md` | `TASK-0007` cardinality syntax tests; `TASK-0008` cardinality IR tests; later cardinality behavior tests | accepted |
...
| `REQ-SCHEMA-006` | `ADR-0009` | `compiler-pipeline.md`, `module-boundaries.md` | `TASK-0007` namespace syntax tests; `TASK-0008` QName/namespace IR tests; later multi-namespace examples | accepted |
...
| `REQ-NS-001` | `ADR-0009` | `compiler-pipeline.md`, `generated-code-contract.md` | `TASK-0008` QName/namespace IR tests; later binding config tests | accepted |
