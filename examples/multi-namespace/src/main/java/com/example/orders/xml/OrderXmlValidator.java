...
/** Generated XML validator for {@link com.example.orders.Order}. */
public final class OrderXmlValidator {
  ...
  public static io.github.mundanej.mxjb.runtime.ValidationResult validate(
    ...
    try {
      return validate(com.example.orders.xml.OrderXmlReader.read(input));
  ...
  private static void validateOrder(
    ...
    if (value.line() == null || value.line().isEmpty()) {
      ...
      for (com.example.lines.Line item : value.line()) {
        if (item == null) {
