...
/** Generated XML reader for {@link com.example.substitution.Payment}. */
public final class PaymentXmlReader {
  ...
  private PaymentXmlReader() {}

  public static com.example.substitution.Payment read(
    ...
    if (input.kind() != io.github.mundanej.mxjb.runtime.XmlEventKind.START_ELEMENT
      ...
      throw readException(input, "MXJB-GR-001", "Expected root element {urn:substitution}payment.");
    }
    com.example.substitution.Payment value = readPayment(input, NAME_1);
