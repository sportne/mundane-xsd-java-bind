...
/** Generated XML validator for {@link com.example.substitution.Cardpayment}. */
public final class CardpaymentXmlValidator {
  private CardpaymentXmlValidator() {}
  ...
  public static io.github.mundanej.mxjb.runtime.ValidationResult validate(
    ...
    validateCardpayment(value, io.github.mundanej.mxjb.runtime.XmlLocation.UNKNOWN, errors);
  ...
  public static io.github.mundanej.mxjb.runtime.ValidationResult validate(
    ...
    try {
      return validate(com.example.substitution.xml.CardpaymentXmlReader.read(input));
